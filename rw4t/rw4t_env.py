...
if __name__ == '__main__':
  pref_dict = pref_dicts['six_by_six_7_train_pref_dict']
  base_env = RW4TEnv(map_name='six_by_six_7_train_map',
                     low_level=True,
                     pref_dict=pref_dict,
                     seed=0)
  # print(base_env.hl_action_space)
  # print(base_env.rw4t_hl_actions)
