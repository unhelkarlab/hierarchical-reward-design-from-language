...
case "$train" in
    true)  python_script="train/run_ll.py" ;;  # Training script
    false) python_script="eval/eval_ll.py" ;;   # Evaluation script
...
for idx in $(seq $start_idx $((end_idx - 1))); do
    ...
    session_name="${env_name}_LL_seed-idx${idx}_${train_str}"
