...
def popup_text(description: str = '', fill_in: str = ''):
  root = Tk()
...
def popup_choice(description: str, choices: List[str]):
  root = Tk()
...
def popup_box(description: str = ''):
  ...
  label = Label(text=description, font=('Times New Roman', 15, 'bold'))
  display_yes = Button(root,
                       height=2,
                       width=5,
                       text="Yes",
                       command=lambda: take_yes())
  display_no = Button(root,
                      height=2,
                      width=5,
                      text="No",
                      command=lambda: take_no())
